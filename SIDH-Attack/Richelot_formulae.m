...
* slightly adapted to apply the Castryck-Decru Attack
...
RichelotChain_splitnew := function(type2_invariants, kernel,n: P_list:=[], partition:=[])
  /*
  ...
  *           - partition: use speed-up  (as in Remark 5.5)
  ...
  */
  ...
  //last step, check if split (this is certainly not optimal)
