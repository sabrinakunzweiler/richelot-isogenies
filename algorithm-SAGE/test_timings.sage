...
print("Result", Ynew.absolute_igusa_invariants_kohel())
...
print("CPU time for Richelot chain (Round 1): %o\n", cputime(t1))
t2 = cputime();
hnew = IsogenyChainPO(h,kernel,[],a);
print("CPU time for Richelot chain (Round 2): %o\n", cputime(t2))
Ynew2 = HyperellipticCurve(hnew[0]);

print("Result:", Ynew2.absolute_igusa_invariants_kohel())
